...
# Created by write_sdc on Thu Oct 13 00:00:55 2022
...
create_generated_clock [get_pins TX_DIV1/o_div_clk]  -name UART_TX_CLK  -source [get_ports UART_CLK]  -master_clock UART_RX_CLK  -divide_by 8  -add
create_generated_clock [get_pins CLK_Gate1/Gated_CLK]  -name ALU_CLK  -source [get_ports REF_CLK]  -master_clock REF_CLK  -divide_by 1  -add
